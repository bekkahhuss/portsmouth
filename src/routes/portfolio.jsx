          ...
          <Row className="Row-space">
                  ...
                  <Accordion defaultActiveKey="1">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        ...
                        website allows users to search for common products, and
                        display their price in dollars and the equivalent in
                        Bitcoin, Ethereum, Binance Coin, Cardano and Solana(Top
                        5 Cryptos by Market Cap). Searches are persistent across
                  ...
                  <Accordion defaultActiveKey="1">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        ...
                        post opportunities to care for their pets when they are
                        unable to and allows potential pet caregivers to accept
                        those opportunities.
                      </Accordion.Body>
                    </Accordion.Item>
                  </Accordion>
            ...
            <Col>
              <Card>
                ...
                />
                <Card.Body>
                  <Card.Title>Agora</Card.Title>
                  <Button
                    className="cardButton"
                    variant="primary"
                    href="https://github.com/gemsjohn/agora"
                  >
                    View Code
                  </Button>
                  <Accordion defaultActiveKey="1">
                    <Accordion.Item eventKey="0">
                      <Accordion.Header>View Description</Accordion.Header>
                      <Accordion.Body>
                        Agora offers an alternative to Craigslist or FB
                        Marketplace. We don’t charge for listings or sell your
                        personal information. Users sign up for an account,
                        login and can create listings for items that they wish
                        to sell. They can upload images, choose categories,
                        conditions and tags to describe the item.
                      </Accordion.Body>
                    </Accordion.Item>
                  </Accordion>
                </Card.Body>
                  ...
                  <Accordion defaultActiveKey="1">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        ...
                        friends and react to other users thoughts. This version
                        of of social-genie has the ability to start the server
                        and and sync Mongoose models to the MongoDB database.
                      </Accordion.Body>
                    </Accordion.Item>
                  </Accordion>
                </Card.Body>
